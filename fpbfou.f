...
c  ..scalar arguments..
      integer n
      double precision par   ! DP: upgraded from REAL
c  ..array arguments..
      double precision t(n),ress(n),resc(n)   ! DP: upgraded from REAL
c  ..local scalars..
      integer i,ic,ipj,is,j,jj,jp1,jp4,k,li,lj,ll,nmj,nm3,nm7
      double precision ak,beta,con1,con2,c1,c2,delta,eps,fac,f1,f2,f3,
     * one,quart,! DP: upgraded from REAL
     * sign,six,s1,s2,term
c  ..local arrays..
      double precision co(5),si(5),hs(5),hc(5),rs(3),rc(3)   ! DP: upgraded from REAL
c  ..function references..
      double precision cos,sin,abs   ! DP: upgraded from REAL
c  ..
c  initialization.
      one = 0.1D+01
      six = 0.6D+01
